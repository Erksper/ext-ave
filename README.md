...
```
(npm run sync; cd site; vendor/bin/phpunit tests/unit/Espo/Modules/AVE)
```
...
```
(npm run sync; cd site; vendor/bin/phpunit tests/integration/Espo/Modules/AVE)
```
...
If your extension contains additional PHP packages, you also need to add `site/custom/Espo/Modules/AVE/vendor` to the *scanDirectories* section in *phpstan.neon* config.
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/AVE`
* `site/tests/integration/Espo/Modules/AVE`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/AVE/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/AVE/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/a-v-e/lib/init.js"
        ]
    }
    ```
...
Add the library module path to `src/files/custom/Espo/Modules/AVE/Resources/metadata/app/jsLibs.json`

```json
{
    "some-lib": {
        "path": "client/custom/modules/a-v-e/lib/some-lib.js"
    }
}
```
